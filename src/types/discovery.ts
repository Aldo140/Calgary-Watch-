...
export interface EntityBase {
  ...
  status: 'draft' | 'published'; verification: 'unverified' | 'source-checked';
...
export interface EntitySubmission { id: string; submittedBy: string; entity: DiscoveryEntity; status: 'pending' | 'approved' | 'rejected' }
