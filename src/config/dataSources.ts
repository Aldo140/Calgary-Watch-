...
export const DATA_SOURCES = [
  ...
  {
    id: 'aggregate_traffic_flow',
    name: 'Aggregate road traffic flow',
    shortName: 'Traffic flow',
    description: 'Privacy-safe road-segment speeds and counts; no device, plate, trip, or vehicle identifiers.',
