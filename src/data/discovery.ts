...
export const discoveryFixtures: DiscoveryEntity[] = [
  ...
  { ...base, kind: 'event', id: 'event-city', slug: 'city-after-hours', title: 'Make an evening of it', summary: 'Good company. A new corner of the city. No big itinerary required.', categories: ['arts'], tags: ['date night'], start: '2026-09-26T18:00:00-06:00', end: '2026-09-26T21:00:00-06:00', timezone: 'America/Edmonton', pricing: 'unknown', organizer: 'Sample organizer', address: 'Calgary', image: { src: '/images/photo/calgary3.webp', alt: 'Traffic light trails under the Calgary skyline at night' } },
