...
export default function LayerToggle({ showLiveReports, setShowLiveReports, showHeatmap, setShowHeatmap }: LayerToggleProps) {
  return (
    <div className="absolute bottom-20 md:bottom-8 left-1/2 -translate-x-1/2 z-30 w-auto max-w-[94vw]">
      <Card className="flex items-center gap-1 md:gap-2 p-1.5 md:p-1.5 bg-slate-950/80 light:bg-white/95 backdrop-blur-2xl border-white/10 light:border-slate-300 shadow-2xl rounded-2xl whitespace-nowrap overflow-x-auto no-scrollbar">
        ...
        <button
          ...
          className={cn(
            'layer-chip flex items-center gap-1.5 md:gap-2 px-3.5 md:px-4 py-2 md:py-2 rounded-xl transition-all shrink-0',
