 ...
 *  - 'demo'       Illustrative sample showing how reporting works. Always
 *                 badged in the UI and excluded from every count and score,
 *                 so it can never be mistaken for a real neighbour's report
 *                 or skew area intelligence.
 */
